<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="EIA_CarbonFootprintCalculator.About" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main aria-labelledby="title">
        ...
        <p>Our team is your secret weapon: We boast a team of passionate experts with deep experience in regenerative agriculture, 
            ...
            and shape policies that empower sustainable growth.</p>
        <p>Join us. Be the change: Together, we can rewrite the narrative. 
            Partner with Ecoimpact Africa and let's build a thriving, sustainable future for Africa, one agribusiness at a time.</p>
    </main>
</asp:Content>
